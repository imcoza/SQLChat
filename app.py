...
def sql_infer(db, chain, user_question):
    ...
    return ans["text"]
def main():
    st.set_page_config(page_icon="📊", layout="wide", page_title="QueryConverse")
    st.title("QueryConverse - that combines query of the relational database and converse to chat.")
